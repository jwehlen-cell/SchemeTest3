-- LEGACY CORRUPTED EXTRACT (ARCHIVED)
-- This file contains the original raw FK lines with formatting issues (split identifiers,
-- fragmented composite relationships, and phantom columns). It is retained solely for
-- historical reference. DO NOT USE for deployment.
-- Use `oracle_foreign_keys_clean.sql` (generated by export_foreign_keys.py) instead.
