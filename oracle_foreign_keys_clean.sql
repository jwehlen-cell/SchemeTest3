...
ALTER TABLE CLUSTER_MAGREF ADD CONSTRAINT CLU_MAGREF_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
ALTER TABLE CLUSTER_MEC ADD CONSTRAINT CLUSTER_MEC_FK_002 FOREIGN KEY (ACTIVETIME) REFERENCES CLUSTER_STATION (ACTIVETIME);
ALTER TABLE CLUSTER_MEC ADD CONSTRAINT CLU_MEC_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
ALTER TABLE CLUSTER_ORID ADD CONSTRAINT CLUSTER_ORID_FK_003 FOREIGN KEY (ACTIVETIME) REFERENCES CLUSTER_STATION (ACTIVETIME);
ALTER TABLE CLUSTER_ORID ADD CONSTRAINT CLU_ORID_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
...
ALTER TABLE CLUSTER_OVERRIDE ADD CONSTRAINT CLU_OVRD_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
ALTER TABLE CLUSTER_STATION ADD CONSTRAINT CLU_STA_CLUSTER_INFO_CLUID_FK FOREIGN KEY (CLUID) REFERENCES CLUSTER_INFO (CLUID);
ALTER TABLE CLUSTER_THRESHOLD ADD CONSTRAINT CLU_THRESH_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
ALTER TABLE CODAMAG_INPUT ADD CONSTRAINT CODAMAGIN_AMPLITUDE_AMPID_FK FOREIGN KEY (AMPID) REFERENCES AMPLITUDE (AMPID);
ALTER TABLE CODAMAG_OUTPUT ADD CONSTRAINT CODAMAGOUT_CODAMAGIN_COMPOSITE_FK FOREIGN KEY (AMPID, FLO, FHI) REFERENCES CODAMAG_INPUT (AMPID, FLO, FHI);
ALTER TABLE CODAMAG_OUTPUT ADD CONSTRAINT CODAMAG_OUTPUT_FK_006 FOREIGN KEY (FLO) REFERENCES CODAMAG_INPUT (FLO);
ALTER TABLE DEFINING_RULES ADD CONSTRAINT DEF_RULES_DEF_OBS_OBS_ID_FK2 FOREIGN KEY (OBSTYPE_ID) REFERENCES DEFINING_OBSTYPES (OBSTYPE_ID);
...
ALTER TABLE EVENT_CORRELATION ADD CONSTRAINT EVT_CORR_EVT_SRC_EVID_EVID_FK2 FOREIGN KEY (SOURCE_EVID) REFERENCES EVENT (EVID);
ALTER TABLE EVENT_CORRELATION ADD CONSTRAINT EVT_CORR_ORIG_SRC_ORID_ORID_FK2 FOREIGN KEY (SOURCE_ORID) REFERENCES ORIGIN (ORID);
ALTER TABLE EVENT_QUALITY ADD CONSTRAINT EVENT_QUALITY_ORIGIN_ORID_FK FOREIGN KEY (ORID) REFERENCES ORIGIN (ORID);
ALTER TABLE FEEDBACK_CATAFFILIATION ADD CONSTRAINT FBCATAFFIL_FB_FEEDBACK_ID_FK2 FOREIGN KEY (FEEDBACK_ID) REFERENCES FEEDBACK (FEEDBACK_ID);
ALTER TABLE FEEDBACK_SCREENSHOTS ADD CONSTRAINT FBSCRNSHOTS_FB_FEEDBACK_ID_FK2 FOREIGN KEY (FEEDBACK_ID) REFERENCES FEEDBACK (FEEDBACK_ID);
...
ALTER TABLE FILTER_GROUP ADD CONSTRAINT FILTER_GRP_FILT_C_FILTERID_FK2 FOREIGN KEY (CHILD_FILTERID) REFERENCES FILTER (FILTERID);
ALTER TABLE FILTER_GROUP ADD CONSTRAINT FILTER_GRP_FILT_P_FILTERID_FK2 FOREIGN KEY (PARENT_FILTERID) REFERENCES FILTER (FILTERID);
...
ALTER TABLE HISTORIC_INFO_SHELL ADD CONSTRAINT HIST_SHELL_ALGORITHM_ID_FK2 FOREIGN KEY (ALGORITHM_ID) REFERENCES ALGORITHM (ALGORITHM_ID);
ALTER TABLE HISTORIC_INFO_STA_PHASE ADD CONSTRAINT HIST_INFO_STA_PHS_CYL_ID_FK3 FOREIGN KEY (HISTORIC_INFO_CYLINDER_ID) REFERENCES HISTORIC_INFO_CYLINDER (HISTORIC_INFO_CYLINDER_ID);
...
ALTER TABLE MDAC_FD ADD CONSTRAINT MDAC_FD_MDAC_FI_CORRID_FK2 FOREIGN KEY (CORRID) REFERENCES MDAC_FI (CORRID);
...
ALTER TABLE SADO_EMAIL_HISTORY ADD CONSTRAINT SADO_EH_SADO_REP_REPORT_ID_FK2 FOREIGN KEY (REPORT_ID) REFERENCES SADO_REPORT (REPORT_ID);
ALTER TABLE SADO_PDF_REPORTS ADD CONSTRAINT SADO_PR_SADO_REP_REPORT_ID_FK2 FOREIGN KEY (REPORT_ID) REFERENCES SADO_REPORT (REPORT_ID);
ALTER TABLE SADO_REPORT_LANDMARKS ADD CONSTRAINT SADO_RL_SADO_REP_REPORT_ID_FK2 FOREIGN KEY (REPORT_ID) REFERENCES SADO_REPORT (REPORT_ID);
ALTER TABLE SADO_SCREENSHOTS ADD CONSTRAINT SADO_SS_SADO_REP_REPORT_ID_FK2 FOREIGN KEY (REPORT_ID) REFERENCES SADO_REPORT (REPORT_ID);
...
ALTER TABLE STATION_PROCESSING ADD CONSTRAINT STA_PROC_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
...
ALTER TABLE SVDDISC ADD CONSTRAINT SVDDISC_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
ALTER TABLE SVDDISC ADD CONSTRAINT SVDDISC_FK_010 FOREIGN KEY (ACTIVETIME) REFERENCES CLUSTER_STATION (ACTIVETIME);
ALTER TABLE SVDDISC_CHAN_ORDER ADD CONSTRAINT SVD_CH_ORD_CLU_STA_CA_AT_FK2 FOREIGN KEY (CLUSTAID, ACTIVETIME) REFERENCES CLUSTER_STATION (CLUSTAID, ACTIVETIME);
