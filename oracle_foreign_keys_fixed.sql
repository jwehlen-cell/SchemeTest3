...
ALTER TABLE CLUSTER_THRESHOLD ADD CONSTRAINT CLUSTER_THRESHOLD_FK_005 FOREIGN KEY (ACTIVETIME) REFERENCES CLUSTER_STATION (AC TIVETIME);
...
ALTER TABLE STATION_PROCESSING ADD CONSTRAINT STATION_PROCESSING_FK_009 FOREIGN KEY (ACTIVETIME) REFERENCES CLUSTER_STATION (A CTIVETIME);
...
ALTER TABLE SVDDISC_CHAN_ORDER ADD CONSTRAINT SVDDISC_CHAN_ORDER_FK_011 FOREIGN KEY (ACTIVETIME) REFERENCES CLUSTER_STATION (A CTIVETIME);
